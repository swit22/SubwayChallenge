function [ routes, transfers, start, finish, duration ] = SubChallenge( input, variation )
...
% Set up model. Need one variable for each route, and two for each station,
%and one for each transfer.
